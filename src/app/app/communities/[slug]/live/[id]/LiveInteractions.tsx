  ...
  return (
    <>
      ...
      <button
        ...
        className={`rounded-sm border px-4 py-2.5 text-small font-semibold transition ${
          handRaised
      ...
      <details className="group relative">
        <summary className="flex cursor-pointer list-none items-center rounded-sm border border-border bg-card px-4 py-2.5 text-small font-semibold text-text hover:border-primary">
          👍 React
        </summary>
      ...
      {handCount > 0 && (
        <span className="flex items-center rounded-sm border border-border bg-bg px-3 py-2.5 text-caption font-semibold text-text-secondary">
