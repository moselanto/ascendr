...
import { createLivePoll, voteLivePoll, closeLivePoll } from "@/app/app/live-actions";
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {canModerate && showCreate && (
        ...
        >
          ...
          <input
            ...
            className="w-full rounded-sm border border-border bg-card px-3 py-2 text-small focus:outline-none focus:border-primary"
          />
          <div className="mt-2 flex flex-col gap-1.5">
            {[0, 1, 2, 3].map((i) => (
              <input
                ...
                required={i < 2}
                className="w-full rounded-sm border border-border bg-card px-3 py-1.5 text-small focus:outline-none focus:border-primary"
              />
            ))}
          </div>
          <button
      ...
      {sorted.map((poll) => {
        ...
        return (
          <div key={poll.id} className="rounded-md border border-border p-3">
